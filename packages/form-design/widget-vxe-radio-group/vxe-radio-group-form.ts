...
export const WidgetVxeRadioGroupFormComponent = defineVxeComponent({
  props: {
    renderOpts: {
    ...
    renderParams: {
      type: Object as PropType<VxeGlobalRendererHandles.RenderFormDesignWidgetFormViewParams<WidgetVxeRadioGroupFormObjVO>>,
      default: () => ({})
    }
  },
  emits: [],
