...
import type { VxeTableDefines, VxeColumnPropTypes, VxeGridPropTypes, VxeGridProps, VxeGridInstance } from 'vxe-table'
...
export const WidgetSubtableEditComponent = defineVxeComponent({
  ...
  setup (props) {
    const VxeUIFormItemComponent = VxeUI.getComponent('vxe-form-item')
    const VxeUICheckboxComponent = VxeUI.getComponent('vxe-checkbox')
