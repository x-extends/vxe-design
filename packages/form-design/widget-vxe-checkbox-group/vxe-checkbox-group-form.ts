...
export const WidgetVxeCheckboxGroupFormComponent = defineVxeComponent({
  props: {
    renderOpts: {
    ...
    renderParams: {
      type: Object as PropType<VxeGlobalRendererHandles.RenderFormDesignWidgetFormViewParams<WidgetVxeCheckboxGroupFormObjVO>>,
      default: () => ({})
    }
  },
  emits: [],
