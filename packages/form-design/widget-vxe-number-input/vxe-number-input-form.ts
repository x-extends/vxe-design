...
export const WidgetVxeNumberInputFormComponent = defineVxeComponent({
  props: {
    renderOpts: {
    ...
    renderParams: {
      type: Object as PropType<VxeGlobalRendererHandles.RenderFormDesignWidgetFormViewParams<WidgetVxeNumberInputFormObjVO>>,
      default: () => ({})
    }
  },
  emits: [],
