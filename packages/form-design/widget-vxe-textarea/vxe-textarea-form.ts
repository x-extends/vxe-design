...
export const WidgetVxeTextareaFormComponent = defineVxeComponent({
  props: {
    renderOpts: {
    ...
    renderParams: {
      type: Object as PropType<VxeGlobalRendererHandles.RenderFormDesignWidgetFormViewParams<WidgetVxeTextareaFormObjVO>>,
      default: () => ({})
    }
  },
  emits: [],
